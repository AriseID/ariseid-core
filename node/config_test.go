...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "idd.ipc", false, filepath.Join(os.TempDir(), "idd.ipc")},
		{"data", "idd.ipc", false, "data/idd.ipc"},
		{"data", "./idd.ipc", false, "./idd.ipc"},
		{"data", "/idd.ipc", false, "/idd.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "idd.ipc", true, `\\.\pipe\idd.ipc`},
		{"data", "idd.ipc", true, `\\.\pipe\idd.ipc`},
		{"data", `\\.\pipe\idd.ipc`, true, `\\.\pipe\idd.ipc`},
	}
