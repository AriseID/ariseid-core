...
import (
	...
	"github.com/ariseid/ariseid-core/logger"
	"github.com/ariseid/ariseid-core/p2p"
	"github.com/ariseid/ariseid-core/p2p/nat"
	"github.com/ariseid/ariseid-core/whisper"
)
...
func main() {
	...
	// Create an AriseID peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting AriseID peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start AriseID peer: %v.\n", err)
		os.Exit(1)
	}
