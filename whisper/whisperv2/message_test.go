...
// Tests whid a message can be wrapped without any identity or encryption.
...
// Tests whid a message can be signed, and wrapped in plain-text.
...
// Tests whid a message can be encrypted and decrypted using an anonymous
...
// Tests whid a message can be properly signed and encrypted.
