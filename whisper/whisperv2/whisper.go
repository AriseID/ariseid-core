...
import (
	...
	"github.com/ariseid/ariseid-core/event/filter"
...
// Whisper represents a dark communication interface through the AriseID
...
// New creates a Whisper client ready to communicate through the AriseID P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
