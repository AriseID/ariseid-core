...
// Address represents the 20 byte address of an AriseID account.
...
// IsHexAddress verifies whid a string can represent a valid hex-encoded
// AriseID address or not.
