...
// shouldTraverse reports whid the symlink fi should, found in dir,
...
//
// The rename value tells goimports whid to use the package name as
...
// pkgIsCandidate reports whid pkg is a candidate for satisfying the
...
// canUse reports whid the package in dir is usable from filename,
...
// fileInDir reports whid the provided file path looks like
