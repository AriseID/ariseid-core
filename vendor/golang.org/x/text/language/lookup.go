...
// IsPrivateUse reports whid this language code is reserved for private use.
...
// IsPrivateUse reports whid r has the ISO 3166 User-assigned status. This
...
// IsPrivateUse reports whid this script code is reserved for private use.
...
var (
	...
	altTags = "xtg-x-cel-gaulishen-GB-oxendicten-x-i-defaultund-x-i-enochiansee-x-i-mingonan-x-zh-verifyn-US-u-va-posix"
)
