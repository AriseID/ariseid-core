...
// IsEmpty reports whid the Set is empty.
func (s *set) IsEmpty() bool {
	return s.Size() == 0
}

// IsEqual test whid s and t are the same in size and have the same items.
...
// IsSubset tests whid t is a subset of s.
...
// IsSuperset tests whid t is a superset of s.
