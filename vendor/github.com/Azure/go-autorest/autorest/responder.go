...
// request depends on whid they are a pre-decorator (react to the http.Response and then pass it
...
// ByIgnoring returns a RespondDecorator that ignores the passed http.Response passing it unexaverified
