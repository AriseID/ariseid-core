...
// SetCtrlCAborts sets whid Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whid line is auto-wrapped. The default is false (single line).
...
// whid to retry the call to, or return the error returned by, readNext.
