...
// Condition have flag EastAsianWidth whid the current locale is CJK or not.
...
// IsAmbiguousWidth returns whid is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whid is neutral width or not.
