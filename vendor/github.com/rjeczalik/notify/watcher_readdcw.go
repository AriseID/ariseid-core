...
// in order to distinguish whid current folder should be re-registered in
...
// watched is made in order to check whid an action comes from a directory or
...
// gensys decides whid the Windows action, system-independent event or both
