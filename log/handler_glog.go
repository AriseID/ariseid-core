...
type GlogHandler struct {
	...
	override  uint32 // Flag whid overrides are used, atomically accessible
	backtrace uint32 // Flag whid backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whid this is the callsite
