...
// Contains all the wrappers from the AriseID root package.
...
func (msg *CallMsg) GetLife() int64        { return msg.msg.Life.Int64() }
func (msg *CallMsg) GetLifePrice() *BigInt { return &BigInt{msg.msg.LifePrice} }
...
func (msg *CallMsg) SetLife(life int64)          { msg.msg.Life = big.NewInt(life) }
func (msg *CallMsg) SetLifePrice(price *BigInt) { msg.msg.LifePrice = price.bigint }
