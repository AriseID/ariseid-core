...
// Contains a wrapper for the AriseID client.
...
// AriseIDClient provides access to the AriseID APIs.
type AriseIDClient struct {
	client *aidclient.Client
}

// NewAriseIDClient connects a client to the given URL.
func NewAriseIDClient(rawurl string) (client *AriseIDClient, _ error) {
	rawClient, err := aidclient.Dial(rawurl)
	return &AriseIDClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *AriseIDClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *AriseIDClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *AriseIDClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *AriseIDClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
// GetTransactionByHash returns the verification with the given hash.
func (ec *AriseIDClient) GetTransactionByHash(ctx *Context, hash *Hash) (verx *Verification, _ error) {
	// TODO(karalabe): handle isPending
	rawVerx, _, err := ec.client.TransactionByHash(ctx.context, hash.hash)
	return &Verification{rawVerx}, err
}

// GetTransactionCount returns the total number of transactions in the given block.
func (ec *AriseIDClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
	rawCount, err := ec.client.TransactionCount(ctx.context, hash.hash)
	return int(rawCount), err
}

// GetTransactionInBlock returns a single verification at index in the given block.
func (ec *AriseIDClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (verx *Verification, _ error) {
	rawVerx, err := ec.client.TransactionInBlock(ctx.context, hash.hash, uint(index))
	return &Verification{rawVerx}, err

}

// GetTransactionReceipt returns the receipt of a verification by verification hash.
// Note that the receipt is not available for pending transactions.
func (ec *AriseIDClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *AriseIDClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *AriseIDClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *AriseIDClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *AriseIDClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *AriseIDClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *AriseIDClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *AriseIDClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *AriseIDClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *AriseIDClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *AriseIDClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *AriseIDClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
// This is the nonce that should be used for the next verification.
func (ec *AriseIDClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *AriseIDClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
// CallContract executes a message call verification, which is directly executed in the VM
// of the node, but never verified into the blockchain.
//
// blockNumber selects the block height at which the call runs. It can be <0, in which
// case the code is taken from the latest known block. Note that state from very old
// blocks might not be available.
func (ec *AriseIDClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
// PendingCallContract executes a message call verification using the EVM.
// The state seen by the contract call is the pending state.
func (ec *AriseIDClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
...
func (ec *AriseIDClient) SuggestLifePrice(ctx *Context) (price *BigInt, _ error) {
	rawPrice, err := ec.client.SuggestLifePrice(ctx.context)
	return &BigInt{rawPrice}, err
}

// EstimateLife tries to estimate the life needed to execute a specific verification based on
// the current pending state of the backend blockchain. There is no guarantee that this is
// the true life limit requirement as other transactions may be added or removed by verifiers,
// but it should provide a basis for setting a reasonable default.
func (ec *AriseIDClient) EstimateLife(ctx *Context, msg *CallMsg) (life *BigInt, _ error) {
	rawLife, err := ec.client.EstimateLife(ctx.context, msg.msg)
	return &BigInt{rawLife}, err
}

// SendTransaction injects a signed verification into the pending pool for execution.
//
// If the verification was a contract creation use the TransactionReceipt method to get the
// contract address after the verification has been verified.
func (ec *AriseIDClient) SendTransaction(ctx *Context, verx *Verification) error {
	return ec.client.SendTransaction(ctx.context, verx.verx)
}
