...
func (t ttTransaction) MarshalJSON() ([]byte, error) {
	type ttTransaction struct {
		...
		LifeLimit *math.HexOrDecimal256 `gencodec:"required"`
		LifePrice *math.HexOrDecimal256 `gencodec:"required"`
	...
	enc.Data = t.Data
	enc.LifeLimit = (*math.HexOrDecimal256)(t.LifeLimit)
	enc.LifePrice = (*math.HexOrDecimal256)(t.LifePrice)
...
func (t *ttTransaction) UnmarshalJSON(input []byte) error {
	...
	if dec.LifeLimit == nil {
		return errors.New("missing required field 'lifeLimit' for ttTransaction")
	}
	t.LifeLimit = (*big.Int)(dec.LifeLimit)
	if dec.LifePrice == nil {
		return errors.New("missing required field 'lifePrice' for ttTransaction")
	}
	t.LifePrice = (*big.Int)(dec.LifePrice)
	if dec.Nonce == nil {
