...
func (b btHeader) MarshalJSON() ([]byte, error) {
	...
	enc.LifeLimit = (*math.HexOrDecimal256)(b.LifeLimit)
	enc.LifeUsed = (*math.HexOrDecimal256)(b.LifeUsed)
...
func (b *btHeader) UnmarshalJSON(input []byte) error {
	...
	if dec.LifeLimit != nil {
		b.LifeLimit = (*big.Int)(dec.LifeLimit)
	}
	if dec.LifeUsed != nil {
		b.LifeUsed = (*big.Int)(dec.LifeUsed)
	}
