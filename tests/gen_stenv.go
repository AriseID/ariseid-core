...
func (s stEnv) MarshalJSON() ([]byte, error) {
	type stEnv struct {
		...
		LifeLimit   *math.HexOrDecimal256    `json:"currentLifeLimit"   gencodec:"required"`
	...
	enc.LifeLimit = (*math.HexOrDecimal256)(s.LifeLimit)
...
func (s *stEnv) UnmarshalJSON(input []byte) error {
	...
	if dec.LifeLimit == nil {
		return errors.New("missing required field 'currentLifeLimit' for stEnv")
	}
	s.LifeLimit = (*big.Int)(dec.LifeLimit)
	if dec.Number == nil {
