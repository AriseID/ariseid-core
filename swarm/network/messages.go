...
import (
	...
	"github.com/ariseid/ariseid-core/swarm/network/kademlia"
	"github.com/ariseid/ariseid-core/swarm/services/swap"
...
Timeout serves to indicate whid the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whid responder is expected to deliver content
