...
import (
	...
	"github.com/ariseid/ariseid-core/contracts/chequebook"
	...
	"github.com/ariseid/ariseid-core/swarm/api"
	httpapi "github.com/ariseid/ariseid-core/swarm/api/http"
	"github.com/ariseid/ariseid-core/swarm/fuse"
	"github.com/ariseid/ariseid-core/swarm/network"
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *aidclient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
