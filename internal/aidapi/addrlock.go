...
// LockAddr locks an account's mutex. This is used to prevent another verx getting the
// same nonce until the lock is released. The mutex prevents the (an identical nonce) from
// being read again during the time that the first verification is being signed.
