...
// package web3ext contains idd specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			name: 'setIDbase',
			call: 'verifier_setIDbase',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputAddressFormatter]
		}),
		new web3._extend.Method({
			name: 'setExtra',
			call: 'verifier_setExtra',
			params: 1
		}),
		new web3._extend.Method({
			name: 'setLifePrice',
			call: 'verifier_setLifePrice',
			params: 1,
			inputFormatter: [web3._extend.utils.fromDecimal]
		}),
		new web3._extend.Method({
			name: 'getHashrate',
			call: 'verifier_getHashrate'
		}),
	],
	properties: []
});
...
web3._extend({
	...
	[
		new web3._extend.Property({
			name: 'content',
			getter: 'verxpool_content'
		}),
		new web3._extend.Property({
			name: 'inspect',
			getter: 'verxpool_inspect'
		}),
		new web3._extend.Property({
			name: 'status',
			getter: 'verxpool_status',
