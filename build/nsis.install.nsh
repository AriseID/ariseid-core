Name "idd ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/ariseid/ariseid-core/issues"
!define UPDATEURL "https://github.com/ariseid/ariseid-core/releases"
!define ABOUTURL "https://github.com/ariseid/ariseid-core#ariseid-go"
...
# Install idd binary
Section "Idd" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Idd}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\idd.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\idd.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Idd incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Idd outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Idd UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Idd incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\idd.exe" "" "" "AriseID" 30303 "" "" ""
  SimpleFC::AdvAddRule "Idd outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\idd.exe" "" "" "AriseID" "" 30303 "" ""
  SimpleFC::AdvAddRule "Idd UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\idd.exe" "" "" "AriseID" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ariseid/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\idd.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\idd.ipc"
