...
# 1. install idd for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for idd
# 5. create idd, attach and uninstall start menu entries
...
!define GROUPNAME "AriseID"
!define APPNAME "Idd"
!define DESCRIPTION "Official Go implementation of the AriseID protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since idd is installed global
