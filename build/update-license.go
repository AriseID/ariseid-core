...
Please review the resulting diff to check whid the correct
...
var (
	...
	authorsFileHeader = "# This is the official list AriseID authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The AriseID Authors
