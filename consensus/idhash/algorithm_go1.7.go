...
// cacheSize calculates and returns the size of the idhash verification cache that
...
// datasetSize calculates and returns the size of the idhash verifying dataset that
