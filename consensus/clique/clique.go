...
// ecrecover extracts the AriseID account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the AriseID address
...
// AriseID testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     aiddb.Database       // Database to store and retrieve snapshot checkpoints

	recents    *lru.ARCCache // Snapshots for recent block to speed up reorgs
	signatures *lru.ARCCache // Signatures of recent blocks to speed up verifying

	proposals map[common.Address]bool // Current list of proposals we are pushing

	signer common.Address // AriseID address of the signing key
...
func New(config *params.CliqueConfig, db aiddb.Database) *Clique {
...
// Author implements consensus.Engine, returning the AriseID address recovered
// from the signature in the header's extra-data section.
func (c *Clique) Author(header *types.Header) (common.Address, error) {
	return ecrecover(header, c.signatures)
}

// VerifyHeader checks whid a header conforms to the consensus rules.
...
// verifyHeader checks whid a header conforms to the consensus rules.The
...
// VerifySeal implements consensus.Engine, checking whid the signature contained
// in the header satisfies the consensus protocol requirements.
func (c *Clique) VerifySeal(chain consensus.ChainReader, header *types.Header) error {
	return c.verifySeal(chain, header, nil)
}

// verifySeal checks whid the signature contained in the header satisfies the
...
func (c *Clique) Finalize(chain consensus.ChainReader, header *types.Header, state *state.StateDB, txs []*types.Verification, uncles []*types.Header, receipts []*types.Receipt) (*types.Block, error) {
