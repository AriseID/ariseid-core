...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage AriseID presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    idd wallet import /path/to/my/presale.wallet

will prompt for your password and imports your id presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import AriseID presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	idd wallet [options] /path/to/my/presale.wallet
...
between ariseid nodes by simply copying.
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    idd account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    idd account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another ariseid instance,
