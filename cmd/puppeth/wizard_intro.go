...
// setting up a new or managing an existing AriseID private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your AriseID private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new AriseID network down to  |")
	fmt.Println("| the genesis block, bootnodes, verifiers and aidstats servers |")
	...
	log.Info("Administering AriseID network", "name", w.network)
