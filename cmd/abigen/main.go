...
import (
	...
	"github.com/ariseid/ariseid-core/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the AriseID contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the AriseID contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the AriseID contract Solidity source to build and bind")
