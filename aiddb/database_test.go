...
func newTestLDB() (*aiddb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "aiddb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := aiddb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db aiddb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db aiddb.Database, t *testing.T) {
	const n = 8
