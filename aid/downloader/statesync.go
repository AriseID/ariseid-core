...
// stateReq represents a batch of state fetch requests groupped toidder into
...
type stateReq struct {
	...
	dropped  bool                       // Flag whid the peer dropped off early
}
...
func (s *stateSync) commit(force bool) error {
	if !force && s.bytesUncommitted < aiddb.IdealBatchSize {
		return nil
	}
	start := time.Now()
...
// peer into the state trie, returning whid anything useful was written or any
// error occurred.
