...
// Syncing provides information when this nodes starts synchronising with the AriseID network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ariseid.SyncProgress `json:"status"`
}
