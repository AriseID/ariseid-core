...
var ProtocolName = "aid"

// Supported versions of the aid protocol (first is primary).
...
// aid protocol message codes
const (
	// Protocol messages belonging to aid/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to aid/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
...
type blockBody struct {
	Transactions []*types.Verification // Transactions contained within a block
