...
// Oracle recommends life values based on the content of recent
// blocks. Suitable for both light and full clients.
type Oracle struct {
	backend   aidapi.Backend
...
func NewOracle(backend aidapi.Backend, params Config) *Oracle {
...
// SuggestPrice returns the recommended life value.
...
// getLowestPrice calculates the lowest verification life value in a given block
