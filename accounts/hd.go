...
// the `coin_type` 60' (or 0x8000003C) to AriseID.
//
// The root path for AriseID is m/44'/60'/0'/0 according to the specification
// from https://github.com/ariseid/EIPs/issues/84, albeit it's not set in stone
// yet whid accounts should increment the last component or the children of
