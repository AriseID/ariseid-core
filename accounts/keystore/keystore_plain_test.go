...
func tmpKeyStoreIface(t *testing.T, encrypted bool) (dir string, ks keyStore) {
	d, err := ioutil.TempDir("", "idd-keystore-test")
	if err != nil {
		t.Fatal(err)
	}
	if encrypted {
...
// Test and utils for the key store tests in the AriseID JSON tests;
