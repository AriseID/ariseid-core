...
// Package bind generates AriseID contract Go bindings.
//
// Detailed usage document and tutorial available on the AriseID Wiki page:
// https://github.com/ariseid/ariseid-core/wiki/Native-DApps:-Go-bindings-to-AriseID-contracts
package bind
...
// structured checks whid a method has enough information to return a proper
