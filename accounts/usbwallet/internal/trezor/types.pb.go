...
It has these top-level messages:
	...
	VerxOutputBinType
	TransactionType
	VerxRequestDetailsType
	VerxRequestSerializedType
	IdentityType
	Initialize
	GetFeatures
	Features
	...
	AriseIDVerxAck
	AriseIDSignMessage
	AriseIDVerifyMessage
	AriseIDMessageSignature
	SignIdentity
	SignedIdentity
	GetECDHSessionKey
	ECDHSessionKey
...
// *
// Type of script which will be used for verification output
// @used_in VerxOutputType
...
// *
// Type of information required by verification signing process
// @used_in VerxRequest
...
const (
	...
	ButtonRequestType_ButtonRequest_SignVerx           ButtonRequestType = 8
...
// *
// Structure representing verification input
// @used_in SimpleSignVerx
// @used_in TransactionType
type VerxInputType struct {
...
func (m *VerxInputType) Reset()                    { *m = VerxInputType{} }
func (m *VerxInputType) String() string            { return proto.CompactTextString(m) }
func (*VerxInputType) ProtoMessage()               {}
func (*VerxInputType) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }

const Default_VerxInputType_Sequence uint32 = 4294967295
const Default_VerxInputType_ScriptType InputScriptType = InputScriptType_SPENDADDRESS

func (m *VerxInputType) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *VerxInputType) GetPrevHash() []byte {
	if m != nil {
		return m.PrevHash
	}
	return nil
...
func (m *VerxInputType) GetPrevIndex() uint32 {
...
func (m *VerxInputType) GetScriptSig() []byte {
	if m != nil {
		return m.ScriptSig
	}
	return nil
...
func (m *VerxInputType) GetSequence() uint32 {
	if m != nil && m.Sequence != nil {
		return *m.Sequence
	}
	return Default_VerxInputType_Sequence
}

func (m *VerxInputType) GetScriptType() InputScriptType {
	if m != nil && m.ScriptType != nil {
		return *m.ScriptType
	}
	return Default_VerxInputType_ScriptType
}

func (m *VerxInputType) GetMultisig() *MultisigRedeemScriptType {
	if m != nil {
		return m.Multisig
	}
	return nil
...
func (m *VerxInputType) GetAmount() uint64 {
...
// *
// Structure representing verification output
// @used_in SimpleSignVerx
// @used_in TransactionType
type VerxOutputType struct {
...
func (m *VerxOutputType) Reset()                    { *m = VerxOutputType{} }
func (m *VerxOutputType) String() string            { return proto.CompactTextString(m) }
func (*VerxOutputType) ProtoMessage()               {}
func (*VerxOutputType) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }

func (m *VerxOutputType) GetAddress() string {
...
func (m *VerxOutputType) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *VerxOutputType) GetAmount() uint64 {
	if m != nil && m.Amount != nil {
		return *m.Amount
	}
	return 0
...
func (m *VerxOutputType) GetScriptType() OutputScriptType {
	if m != nil && m.ScriptType != nil {
		return *m.ScriptType
	}
...
func (m *VerxOutputType) GetMultisig() *MultisigRedeemScriptType {
	if m != nil {
		return m.Multisig
	}
	return nil
...
func (m *VerxOutputType) GetOpReturnData() []byte {
	if m != nil {
...
// *
// Structure representing compiled verification output
// @used_in TransactionType
type VerxOutputBinType struct {
...
func (m *VerxOutputBinType) Reset()                    { *m = VerxOutputBinType{} }
func (m *VerxOutputBinType) String() string            { return proto.CompactTextString(m) }
func (*VerxOutputBinType) ProtoMessage()               {}
func (*VerxOutputBinType) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }

func (m *VerxOutputBinType) GetAmount() uint64 {
	if m != nil && m.Amount != nil {
		return *m.Amount
	}
	return 0
...
func (m *VerxOutputBinType) GetScriptPubkey() []byte {
	if m != nil {
...
// *
// Structure representing verification
// @used_in SimpleSignVerx
type TransactionType struct {
	Version          *uint32            `protobuf:"varint,1,opt,name=version" json:"version,omitempty"`
	Inputs           []*VerxInputType     `protobuf:"bytes,2,rep,name=inputs" json:"inputs,omitempty"`
	BinOutputs       []*VerxOutputBinType `protobuf:"bytes,3,rep,name=bin_outputs,json=binOutputs" json:"bin_outputs,omitempty"`
	Outputs          []*VerxOutputType    `protobuf:"bytes,5,rep,name=outputs" json:"outputs,omitempty"`
...
func (m *TransactionType) GetInputs() []*VerxInputType {
	if m != nil {
		return m.Inputs
	}
	return nil
...
func (m *TransactionType) GetBinOutputs() []*VerxOutputBinType {
	if m != nil {
		return m.BinOutputs
	}
	return nil
...
func (m *TransactionType) GetOutputs() []*VerxOutputType {
	if m != nil {
		return m.Outputs
	}
	return nil
...
// @used_in VerxRequest
type VerxRequestDetailsType struct {
	RequestIndex     *uint32 `protobuf:"varint,1,opt,name=request_index,json=requestIndex" json:"request_index,omitempty"`
	VerxHash           []byte  `protobuf:"bytes,2,opt,name=verx_hash,json=txHash" json:"verx_hash,omitempty"`
...
func (m *VerxRequestDetailsType) Reset()                    { *m = VerxRequestDetailsType{} }
func (m *VerxRequestDetailsType) String() string            { return proto.CompactTextString(m) }
func (*VerxRequestDetailsType) ProtoMessage()               {}
func (*VerxRequestDetailsType) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }

func (m *VerxRequestDetailsType) GetRequestIndex() uint32 {
...
func (m *VerxRequestDetailsType) GetVerxHash() []byte {
	if m != nil {
		return m.VerxHash
	}
	return nil
...
func (m *VerxRequestDetailsType) GetExtraDataLen() uint32 {
	if m != nil && m.ExtraDataLen != nil {
		return *m.ExtraDataLen
	}
	return 0
...
func (m *VerxRequestDetailsType) GetExtraDataOffset() uint32 {
...
// @used_in VerxRequest
type VerxRequestSerializedType struct {
	...
	SerializedVerx     []byte  `protobuf:"bytes,3,opt,name=serialized_tx,json=serializedVerx" json:"serialized_tx,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}

func (m *VerxRequestSerializedType) Reset()                    { *m = VerxRequestSerializedType{} }
func (m *VerxRequestSerializedType) String() string            { return proto.CompactTextString(m) }
func (*VerxRequestSerializedType) ProtoMessage()               {}
func (*VerxRequestSerializedType) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }

func (m *VerxRequestSerializedType) GetSignatureIndex() uint32 {
...
func (m *VerxRequestSerializedType) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *VerxRequestSerializedType) GetSerializedVerx() []byte {
	if m != nil {
		return m.SerializedVerx
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*VerxInputType)(nil), "VerxInputType")
	proto.RegisterType((*VerxOutputType)(nil), "VerxOutputType")
	proto.RegisterType((*VerxOutputBinType)(nil), "VerxOutputBinType")
	proto.RegisterType((*TransactionType)(nil), "TransactionType")
	proto.RegisterType((*VerxRequestDetailsType)(nil), "VerxRequestDetailsType")
	proto.RegisterType((*VerxRequestSerializedType)(nil), "VerxRequestSerializedType")
