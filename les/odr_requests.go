...
var (
	...
	errVerxHashMismatch      = errors.New("verification hash mismatch")
...
type LesOdrRequest interface {
	...
	Validate(aiddb.Database, *Msg) error
}
...
func (r *BlockRequest) Validate(db aiddb.Database, msg *Msg) error {
	...
	if header.VerxHash != types.DeriveSha(types.Transactions(body.Transactions)) {
		return errVerxHashMismatch
	}
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ReceiptsRequest) Validate(db aiddb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *TrieRequest) Validate(db aiddb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *CodeRequest) Validate(db aiddb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ChtRequest) Validate(db aiddb.Database, msg *Msg) error {
