...
import (
	...
	"github.com/ariseid/ariseid-core/les/flowcontrol"
...
func testChainGen(i int, block *core.BlockGen) {
	...
	case 1:
		...
		nonce++
		tx3, _ := types.SignVerx(types.NewContractCreation(nonce, big.NewInt(0), big.NewInt(200000), big.NewInt(0), testContractCode), signer, acc1Key)
...
func newTestProtocolManager(lightSync bool, blocks int, generator func(int, *core.BlockGen), peers *peerSet, odr *LesOdr, db aiddb.Database) (*ProtocolManager, error) {
	var (
...
// fails the test.
func newTestProtocolManagerMust(t *testing.T, lightSync bool, blocks int, generator func(int, *core.BlockGen), peers *peerSet, odr *LesOdr, db aiddb.Database) *ProtocolManager {
