...
// Creates an ariseid address given the bytes and the nonce
...
// controls whid the key's length should be enforced at the curve size or
...
// ValidateSignatureValues verifies whid the signature values are valid with
