...
var (
	// LifeTableHomestead contain the life values for
	// the homestead phase.
	LifeTableHomestead = LifeTable{
		ExtcodeSize: 20,
		ExtcodeCopy: 20,
		Balance:     20,
		SLoad:       50,
	...
	// LifeTableHomestead contain the life re-prices for
	// the homestead phase.
	LifeTableEIP150 = LifeTable{
		ExtcodeSize: 700,
		ExtcodeCopy: 700,
		Balance:     400,
		SLoad:       200,
