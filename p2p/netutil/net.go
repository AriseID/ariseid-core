...
// Contains reports whid the given IP is contained in the list.
...
// IsLAN reports whid an IP is a local network address.
...
// IsSpecialNetwork reports whid an IP is located in a special-use network range
...
// CheckRelayIP reports whid an IP relayed from the given sender IP
