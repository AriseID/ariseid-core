...
func (tn *preverifiedTestnet) findnode(toid NodeID, toaddr *net.UDPAddr, target NodeID) ([]*Node, error) {
...
func (*preverifiedTestnet) waitping(from NodeID) error                  { return nil }
func (*preverifiedTestnet) ping(toid NodeID, toaddr *net.UDPAddr) error { return nil }
