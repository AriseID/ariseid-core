...
import (
	...
	"github.com/ariseid/ariseid-core/p2p/simulations/adapters"
)
...
// starting nodes and connecting them toidder.
//
...
// Connect connects two nodes toidder by calling the "admin_addPeer" RPC
...
type Node struct {
	...
	// Up tracks whid or not the node is running
	Up bool `json:"up"`
}
...
type Conn struct {
	...
	// Up tracks whid or not the connection is active
	Up bool `json:"up"`
...
// nodesUp returns whid both nodes are currently up
