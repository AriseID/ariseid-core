...
type Validator interface {
	...
	// life used.
	ValidateState(block, parent *types.Block, state *state.StateDB, receipts types.Receipts, usedLife *big.Int) error
}
...
// of life used in the process and return an error if any of the internal rules
// failed.
