...
// current blockchain to be used during verification processing.
...
func NewEVMContext(msg Message, header *types.Header, chain ChainContext, author *common.Address) vm.Context {
	// If we don't have an explicit author (i.e. not verifying), extract from the header
	...
	return vm.Context{
		...
		LifePrice:    new(big.Int).Set(msg.LifePrice()),
	}
}
...
// CanTransfer checks wid there are enough funds in the address' account to make a transfer.
// This does not take the necessary life in to account to make the transfer valid.
