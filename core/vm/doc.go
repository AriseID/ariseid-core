...
/*
Package vm implements the AriseID Virtual Machine.
...
of rules defined in the AriseID yellow paper. When the BC VM is invoked it
...
it either runs of life, causes an internal error, returns or stops.
