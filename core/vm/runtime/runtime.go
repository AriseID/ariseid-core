...
func setDefaults(cfg *Config) {
	...
	if cfg.LifeLimit == 0 {
		cfg.LifeLimit = math.MaxUint64
	}
	if cfg.LifePrice == nil {
...
func Create(input []byte, cfg *Config) ([]byte, common.Address, uint64, error) {
	...
	// Call the code with the given configuration.
	code, address, leftOverLife, err := vmenv.Create(
		sender,
		input,
		cfg.LifeLimit,
		cfg.Value,
	)
	return code, address, leftOverLife, err
}
...
func Call(address common.Address, input []byte, cfg *Config) ([]byte, uint64, error) {
	...
	// Call the code with the given configuration.
	ret, leftOverLife, err := vmenv.Call(
		sender,
		address,
		input,
		cfg.LifeLimit,
