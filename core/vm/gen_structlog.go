...
func (s StructLog) MarshalJSON() ([]byte, error) {
	type StructLog struct {
		Pc         uint64                      `json:"pc"`
		Op         OpCode                      `json:"op"`
		Life        math.HexOrDecimal64         `json:"life"`
		LifeCost    math.HexOrDecimal64         `json:"lifeCost"`
	...
	enc.Pc = s.Pc
	enc.Op = s.Op
	enc.Life = math.HexOrDecimal64(s.Life)
	enc.LifeCost = math.HexOrDecimal64(s.LifeCost)
	enc.Memory = s.Memory
...
func (s *StructLog) UnmarshalJSON(input []byte) error {
	...
	if dec.Life != nil {
		s.Life = uint64(*dec.Life)
	}
	if dec.LifeCost != nil {
		s.LifeCost = uint64(*dec.LifeCost)
	}
	if dec.Memory != nil {
		s.Memory = dec.Memory
	}
