...
func TestSetupGenesis(t *testing.T) {
	...
	tests := []struct {
		name       string
		fn         func(aiddb.Database) (*params.ChainConfig, common.Hash, error)
	...
	}{
		{
			...
			fn: func(db aiddb.Database) (*params.ChainConfig, common.Hash, error) {
		...
		},
		{
			...
			fn: func(db aiddb.Database) (*params.ChainConfig, common.Hash, error) {
				...
				bc, _ := NewBlockChain(db, oldcustomg.Config, idhash.NewFullFaker(), vm.Config{})
				defer bc.Stop()
