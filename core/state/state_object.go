...
// stateObject represents an AriseID account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of ariseid address of the account
	data     Account
	db       *StateDB
...
// empty returns whid the account is considered empty.
func (s *stateObject) empty() bool {
	return s.data.Nonce == 0 && s.data.Balance.Sign() == 0 && bytes.Equal(s.data.CodeHash, emptyCodeHash)
}

// Account is the AriseID consensus representation of accounts.
...
// Return the life back to the origin. Used by the Virtual machine or Closures
func (c *stateObject) ReturnLife(life *big.Int) {}
