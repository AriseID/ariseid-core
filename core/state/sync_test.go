...
func makeTestState() (Database, *aiddb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := aiddb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db aiddb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db aiddb.Database, root common.Hash) error {
...
func checkStateConsistency(db aiddb.Database, root common.Hash) error {
