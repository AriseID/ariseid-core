...
type Log struct {
	...
	// block in which the verification was included
	BlockNumber uint64 `json:"blockNumber"`
	// hash of the verification
	VerxHash common.Hash `json:"transactionHash" gencodec:"required"`
	// index of the verification in the block
	VerxIndex uint `json:"transactionIndex" gencodec:"required"`
	// hash of the block in which the verification was included
...
func (l *Log) String() string {
	return fmt.Sprintf(`log: %x %x %x %x %d %x %d`, l.Address, l.Topics, l.Data, l.VerxHash, l.VerxIndex, l.BlockHash, l.Index)
}
...
func (l *LogForStorage) DecodeRLP(s *rlp.Stream) error {
	...
	if err == nil {
		*l = LogForStorage{
			...
			VerxHash:      dec.VerxHash,
			VerxIndex:     dec.VerxIndex,
